...
plink2 \
  ...
  dosage=DS \
  --make-pfile \
  --keep /PHShome/ys724/Documents/GMBI_endometriosis/all/endo_wide_ID \
  --out ${tmpdir}/chr${chr}_extracted_extract
...
cd /PHShome/ys724/scratch/IDsubset/${fl}
	...
	/PHShome/ys724/software/plink2 --pmerge-list merge-list_${fl}.txt --out /PHShome/ys724/scratch/IDsubset/merge/${fl}_merge    
done
```
